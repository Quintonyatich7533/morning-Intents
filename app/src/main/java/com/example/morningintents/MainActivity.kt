...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSMS.setOnClickListener {
            val uri: Uri = Uri.parse("smsto:0757495248")
            val intent = Intent(Intent.ACTION_SENDTO, uri)
            intent.putExtra("sms_body", "Hello Quinton!!!")
            startActivity(intent)
        }
        btnEmail.setOnClickListener {
            val emailIntent =
                Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "quintonyatich@gmail.com", null))
            emailIntent.putExtra(Intent.EXTRA_SUBJECT, "JOB APPLICATION")
            emailIntent.putExtra(Intent.EXTRA_TEXT, "Dear sir, following the advertisement i will like to apply for a job at your company")
        ...
        btnShare.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, "Hey, download this app from https:/.com!")
        ...
        btnCall.setOnClickListener {
            val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "0726342611"))
